...
Isolated counter: Worker `codelock-download-tracker`, KV `CODELOCK_DOWNLOADS`. Not mixed with any other product. `/v1`, `/mcp`, and `/v1/mesh/*` do not increment downloads.
