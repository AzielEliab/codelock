...
<body>
  ...
  <div class="card">
    ...
    <a class="dl" href="/download?asset=codelock-0.1.0.tar.gz">Download codelock-0.1.0.tar.gz — ${n} counted</a>
    ...
    <p class="iso">Isolated counter: Worker <code>codelock-download-tracker</code>, project <code>codelock</code>. Not mixed with any other *Lock.</p>
