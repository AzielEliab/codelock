...
<body>
  <h1>CodeLock downloads</h1>
  <p>This tool alters perception, not meaning.</p>
  <p>CodeLock is a gate-tethered cognitive rendering tool. It is not encryption.</p>
  <p><strong>Hosted download:</strong> <a href="/download?asset=codelock-0.1.0.tar.gz">codelock-0.1.0.tar.gz</a></p>
  <p>GitHub releases: <a href="${GITHUB_RELEASES}">${GITHUB_RELEASES}</a></p>
...
export default {
  async fetch(request, env) {
    ...
    if (url.pathname === "/go" && request.method === "GET") {
      ...
      const asset = dims.asset || "codelock-0.1.0.tar.gz";
